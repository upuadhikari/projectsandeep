...
<div class="container">
        ...
        <div class="row  my-3">
            ...
            <div class="col-md-4 my-auto">
                <form class="d-flex "  action="{{url('seller/blogView/search-blog/')}}" method="POST">
                    @csrf
            ...
            <button class="btn btn-primary ms-1" type="submit"><a href="{{url('/seller/blogView/add-blog')}}" class="btn text-white" type="submit">Add Blog</a></button>
