        ...
        <!-- <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="nav-link text-white px-3">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="nav-link text-white px-3">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="nav-link text-white px-3">Register</a>
                        @endif
                    @endauth
                </div>
            @endif -->
